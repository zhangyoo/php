...
class Material extends ActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('sort_num', 'numerical', 'integerOnly'=>true),
			array('parent_id, create_time, update_time, creater_id, updater_id', 'length', 'max'=>10),
			array('name, letter', 'length', 'max'=>32),
			array('summary', 'length', 'max'=>128),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, parent_id, name, letter, summary, sort_num, create_time, update_time, creater_id, updater_id', 'safe', 'on'=>'search'),
		);
	}
