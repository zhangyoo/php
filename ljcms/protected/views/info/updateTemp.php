                ...
                <tr>
                    ...
                    <th class="col-3" >
                        ...
                        <span>
                            ...
                            <a href="javascript:void(0);" rel="<?php echo $info[0]['id']; ?>" type="info" onclick="changeTSize(this)" style="color:#FF0000">修改顶视图尺寸</a>
                            <?php endif; ?>
                        </span>
                    </th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="javascript:void(0);" obj_id="<?php echo $model['id']; ?>" type="Info" rel="<?php echo $texi['texture']['id']; ?>" onclick="delTexture(this)">删除该颜色贴图</a>
                        <?php endif; ?>
                    </td>
                </tr>
                <?php endforeach; ?>
