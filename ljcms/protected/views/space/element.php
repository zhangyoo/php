                    ...
                    <div class="sectionFoot-B1">
                        <div class="sectionFloat-A1 addpage_style">
                            ...
                            <div class="goToPages">
                                ...
                                echo Yii::app()->request->BaseUrl;?>/space/element/id/<?php echo isset($_GET['id'])?$_GET['id']:""; ?><?php 
...
<script type="text/javascript">
   ...
   $(".all_select").click(function(){
    ...
    function delbatch(){
        ...
        if(data.length > 0){
            if(confirm('确定要删除选择项')){
            $.post('<?php echo CHtml::normalizeUrl(array('/space/batchdelete')); ?>',{'id[]':data}, function (dat) {
    ...
    function changeBindType(cbt){
        var $t = $(cbt).val();
        if($t == 'unbind'){
            window.location.href = '/space/element/id/'+<?php echo isset($_GET['id']) ? $_GET['id'] :""; ?> +"/unbind";
        }else{
            window.location.href = '/space/element/id/'+<?php echo isset($_GET['id']) ? $_GET['id'] :""; ?>;
        }
    }
</script>