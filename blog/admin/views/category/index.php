...
<form method="post">
    <div class="panel admin-panel">
        ...
        <div class="padding border-bottom">
            ...
            <a href="<?php echo yii\helpers\Url::to('/category/create'); ?>" class="button button-small border-green">创建栏目</a>
        ...
        <table class="table table-hover">
            ...
            <tr>
                ...
                <td>
                    <a class="button border-blue button-little" href="<?php echo yii\helpers\Url::to(['/category/update','id'=>$val['id']]); ?>">修改</a>
