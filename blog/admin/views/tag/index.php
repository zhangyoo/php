...
<form method="post">
    <div class="panel admin-panel">
    	<div class="panel-head"><strong>标签列表</strong></div>
        <div class="padding border-bottom">
            <input type="button" class="button button-small checkall" name="checkall" checkfor="id" value="全选" />
            <a href="<?php echo yii\helpers\Url::to('/tag/create'); ?>" class="button button-small border-green">创建标签</a>
        ...
        <table class="table table-hover">
            ...
            <tr>
                ...
                <td>
                    <a class="button border-blue button-little" href="<?php echo yii\helpers\Url::to(['/tag/update','id'=>$val['id']]); ?>">修改</a>
